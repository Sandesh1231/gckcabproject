...
$query=$conn->query("select * from driver where username='$username' and email='$email'");
$fetch=$query->fetch_array();
$row=$query->num_rows;
 if($row>0)
{
 $qu=$conn->query("update driver Set password='$password' where username='$username'");
if($qu==TRUE)
{
...
<TABLE align="center" bordercolor="#999999" background="min.jpg" height="350" width="300">
<caption>
