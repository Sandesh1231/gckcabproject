...
$conn->query("delete from driver where driverid='$driverid'")or
die(mysqli_error());
}
if(isset($_POST['namedelete']))
{
$username=$_POST['username'];
$conn->query("delete from driver where username='$username'")or
die(mysqli_error());
}
...
<form method="post" autocomplete="off">
  <div class="container">
   <center> <h1>DELETE DRIVER</h1></center> 
    <hr>
 <input type="text" placeholder="Enter DriverID" name="driverid" >
